...
Создаем директорию `images` в директории z2m и кладем туда файл [1141-d3a3-1111114b-ts0201_tz3000_zed.zigbee](bin/1141-d3a3-1111114b-ts0201_tz3000_zed.zigbee).
