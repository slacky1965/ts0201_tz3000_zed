#ifndef SRC_COMMON_BOARD_ZTH02_ZBEACON_H_
#define SRC_COMMON_BOARD_ZTH02_ZBEACON_H_

#if (BOARD == BOARD_ZTH02_ZBEACON)
...
#endif /* (BOARD == BOARD_ZTH02_ZBEACON) */


#endif /* SRC_COMMON_BOARD_ZTH02_ZBEACON_H_ */
